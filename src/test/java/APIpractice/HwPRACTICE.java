...
public class HwPRACTICE {
    ...
    public void getListPostsTest(){
        ...
        Response responseListPosts = RestAssured
                .given()
        ...
        Response createPostByUsingUserId = RestAssured
                .given()
                .contentType(ContentType.JSON)
                .headers("Authorization", "Bearer " + AUTH)
                .accept(ContentType.JSON)
                .body(body)
                .when()
              //  .pathParam("user_id",responseGetPostByUserId.jsonPath().getString("50050"))
                .post("/posts/{id}");

        System.out.println(createPostByUsingUserId.asString());
        System.out.println(createPostByUsingUserId.getStatusCode());

        Response responseGetPostByUserId = RestAssured
                ...
                .accept(ContentType.JSON)
                .when()
                .pathParam("id",responseListPosts.jsonPath().getString("id"))
                .get("/posts/{id}");
        System.out.println(responseGetPostByUserId.asString());
        System.out.println(responseGetPostByUserId.getStatusCode());
...
//        );
    ...
    /*
       ...
       ///// Assumptions.assumeTrue(responseCreatePost.getStatusCode() == 201, "Create user didn't return 201 status code");
        ...
        Response responseGetPostById = RestAssured
                //Arrange
                .given()
                .contentType(ContentType.JSON)
                .headers("Authorization", "Bearer " + AUTH)
                ...
                // Act
                .when()
                .pathParam("id",responseCreateUser.jsonPath().getString("id"))
                .get("/users/{userId}");
